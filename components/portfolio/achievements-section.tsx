...
const platformAchievements = [
  {
    ...
    stats: [
      ...
      { label: "Max Rating", value: 1350, suffix: "" },
      { label: "Contest Rating", value: 1200, suffix: "" },
    ],
    badge: "Active",
  ...
  },
  {
    ...
    icon: Star,
    stats: [
      { label: "Max Rating", value: 1200, suffix: "+" },
      { label: "Stars", value: 3, suffix: "★" },
      { label: "Problems Solved", value: 50, suffix: "+" },
    ],
    badge: "3 Star",
    badgeColor: "from-[#D73B02] to-[#FF6B35]",
    description: "Achieved 3-star rating through competitive programming. 3-star in Long Challenges with strong algorithmic skills.",
  },
  {
    platform: "HackerRank",
    icon: Award,
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "Contributions", value: 100, suffix: "+" },
      { label: "Stars Earned", value: 23, suffix: "+" },
    ],
    badge: "Active",
