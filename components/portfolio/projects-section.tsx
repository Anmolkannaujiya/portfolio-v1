...
const projects = [
  ...
  },
  {
    ...
    description: "Console-based timer built using C++ with <thread>, <chrono>, and <ctime>. Displays real-time countdown and timestamps.",
    tech: ["C++"],
    github: "https://github.com/Anmolkannaujiya",
    live: "#",
    featured: false,
  ...
  },
  {
    ...
    description: "Interactive Power BI dashboard analyzing Air Quality Index trends across regions and time periods.",
  ...
  },
  {
    ...
    description: "Exploratory data analysis on US suicide rates by race and gender using Pandas, NumPy, and Seaborn.",
  ...
  },
  {
    ...
    description: "Clean payment form with input validation and interactive UI elements for a seamless checkout flow.",
    tech: ["HTML", "CSS", "JavaScript"],
    github: "https://github.com/Anmolkannaujiya",
    live: "#",
    featured: false,
  },
  {
    ...
    description: "Informational website about solar energy and environmental awareness with a modern visual design.",
    tech: ["HTML", "CSS"],
    github: "https://github.com/Anmolkannaujiya",
    live: "#",
    featured: false,
